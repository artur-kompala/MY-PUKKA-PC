...
function Builder() {
    ...
    if(isLoading || error){
        ...
        return (
            <Row type='horizontal'>
                <BuilderTable setTotalCost={setTotalCost} setTotalPower={setTotalPower} isLoading={isLoading} data={data} refetch={refetch} counter={counter} setCounter={setCounter}></BuilderTable>
